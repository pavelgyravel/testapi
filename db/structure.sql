...
--
-- Name: index_posts_on_rate; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_posts_on_rate ON public.posts USING btree (rate);
...
--
-- Name: index_rates_on_post_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_rates_on_post_id ON public.rates USING btree (post_id);
...
--
-- Name: rates fk_rails_f13668c837; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rates
    ADD CONSTRAINT fk_rails_f13668c837 FOREIGN KEY (post_id) REFERENCES public.posts(id);
